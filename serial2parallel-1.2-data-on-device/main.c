...
#pragma acc enter data create(O1[0:L1->out_size],O3[0:L3->out_size],O4[0:L4->out_size])
#pragma acc enter data create(O6[0:L6->out_size],O7[0:L7->out_size])
...
#pragma acc exit data delete(O1[0:L1->out_size],O3[0:L3->out_size],O4[0:L4->out_size])
#pragma acc exit data delete(O6[0:L6->out_size],O7[0:L7->out_size])
