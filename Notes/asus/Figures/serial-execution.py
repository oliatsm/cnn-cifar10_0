...
# Example data
num_images = [1200, 50000]  # Number of input images
execution_times =  [44.246349, 1648.611241]  # Execution times in seconds
...
with plt.style.context(['science','notebook']):
    ...
    # Show the plot
    plt.savefig('serial-execution.jpg', dpi=300)  # Specify the filename with .jpg extension and optional DPI setting
    plt.close()
...
# Calculate speedup
speedup = [s / p for s, p in zip(serial_asus, parallel_asus)]
...
# Show the plot
plt.savefig('speedup.jpg', dpi=300)  # Specify the filename with .jpg extension and optional DPI setting
plt.close()
